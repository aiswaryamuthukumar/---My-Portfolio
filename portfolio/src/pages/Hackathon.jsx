  ...
  return (
    <section id="hackathon" className="page-section px-5 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-center mb-1 mt-10 md:mt-16 text-center">
          <motion.h2
          ...
          >
            <span className="text-white">HACKATHON</span> <span className="text-[#D89A8F]">EXPERIENCE</span>
          </motion.h2>
          <motion.div
            initial={{ scaleX: 0 }}
