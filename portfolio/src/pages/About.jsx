...
const education = [
  {
    ...
    icon1: (
      <svg className="w-5 h-5 text-[#D89A8F]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    ...
    <section id="about" className="page-section px-5 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-center mb-16 text-center">
          ...
          >
            <span className="text-white">ABOUT</span> <span className="text-[#D89A8F]">ME</span>
          </motion.h2>
          <motion.div
            initial={{ scaleX: 0 }}
            ...
            className="mt-4 h-[2px] w-12 bg-[#D89A8F]"
          />
          ...
          <motion.div
            ...
            className="mt-8 text-[15px] leading-7 text-[#AFAFAF] max-w-2xl mx-auto"
          >
        ...
        >
          {education.map((item) => (
            <motion.article
              key={item.title}
              className="relative flex items-stretch gap-6 p-6 sm:p-8 rounded-2xl bg-[#04070D]/60 border border-[#D89A8F]/15 shadow-lg overflow-hidden group backdrop-blur-md"
              variants={{ hidden: { opacity: 0, y: 30 }, show: { opacity: 1, y: 0 } }}
              transition={{ duration: 0.7, ease: "easeOut" }}
            >
              {/* Subtle Red Top Gradient */}
              <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#D89A8F]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="flex items-center justify-center pl-2">
                <div className="relative w-[100px] h-[100px] rounded-full border border-white/10 flex items-center justify-center">
                  <div className="absolute inset-0 rounded-full border-2 border-[#D89A8F]/30 scale-110"></div>
                  <div className="absolute inset-0 rounded-full border border-[#D89A8F]/10 scale-125"></div>
              ...
              <div className="relative flex flex-col justify-center px-2">
                <div className="h-full w-[1px] bg-[#D89A8F]/20"></div>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-[#D89A8F] rounded-full shadow-[0_0_8px_rgba(232, 180, 170, 0.8)]"></div>
              </div>
              ...
              <div className="flex flex-col justify-center gap-5 flex-1 py-1">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-[#F8F7F4] leading-snug">{item.degree}</h3>
