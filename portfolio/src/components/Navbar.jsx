  ...
  return (
    <>
      <motion.header
        ...
        className={`sticky top-0 z-40 border-b border-transparent bg-transparent ${scrolled ? "navbar-scrolled" : ""}`}
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8 lg:px-12">
          <a href="#home" className="leading-none flex-shrink-0">
            ...
            <p className="mt-3 text-[25px] font-semibold leading-none text-[#D89A8F]">அவளின் உலகம்</p>
          </a>
          ...
          <div className="flex items-center gap-6 lg:gap-10">
              ...
              {navItems.map((item) => {
                ...
                return (
                  <motion.a
                    key={item.href}
                    href={item.href}
                    className={`nav-link hover:text-[#D89A8F] transition-colors ${isActive ? "text-[#D89A8F] active" : ""}`}
                    whileHover={{ y: -2 }}
            ...
            <button
              ...
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#D89A8F]/20 text-[#D89A8F] transition-colors hover:border-[#D89A8F] hover:bg-[#D89A8F]/5"
         ...
         {achievementsOpen && (
           <>
             ...
             <motion.div
               ...
               className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-[#04070D]/40 border-l border-[#D89A8F]/15 shadow-2xl p-8 sm:p-12 overflow-y-auto backdrop-blur-2xl"
            >
              <button
                onClick={() => setAchievementsOpen(false)}
              ...
              <div className="flex items-center gap-4 mb-2 mt-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-[#D89A8F]">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 2.25 12 2.25c2.291 0 4.545.16 6.75.47v1.516M7.73 9.728a6.726 6.726 0 002.748 1.35m8.272-6.842V4.5c0 2.108-.966 3.99-2.48 5.228m2.48-5.492a46.32 46.32 0 012.916.52 6.003 6.003 0 01-5.395 4.972m0 0a6.726 6.726 0 01-2.749 1.35m0 0a6.772 6.772 0 01-3.044 0" />
                </svg>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="absolute -left-[54px] top-1/2 -translate-y-1/2 flex items-center justify-center gap-3">
                        <span className="text-[#D89A8F] text-[13px] font-bold font-mono">0{index + 1}</span>
                        <div className="w-1.5 h-1.5 rounded-full bg-[#D89A8F]"></div>
                      </div>

                      {/* Card */}
                      <div className="bg-[#09111A]/40 border border-[#D89A8F]/15 p-6 rounded-2xl hover:border-[#D89A8F]/30 backdrop-blur-md transition-colors group">
                        <div className="flex gap-4 sm:gap-5 items-start">
                          <div className="shrink-0 mt-0.5">
                            <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 2.25 12 2.25c2.291 0 4.545.16 6.75.47v1.516M7.73 9.728a6.726 6.726 0 002.748 1.35m8.272-6.842V4.5c0 2.108-.966 3.99-2.48 5.228m2.48-5.492a46.32 46.32 0 012.916.52 6.003 6.003 0 01-5.395 4.972m0 0a6.726 6.726 0 01-2.749 1.35m0 0a6.772 6.772 0 01-3.044 0" />
                              <path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5l1.09 2.21 2.44.35-1.77 1.72.42 2.43-2.18-1.15-2.18 1.15.42-2.43-1.77-1.72 2.44-.35L12 7.5z" stroke="#D89A8F" strokeWidth="1.5" />
                            </svg>
                          </div>
                          <div>
                            <h3 className="text-white font-bold text-base mb-1.5">{item.title}</h3>
                            <p className="text-[#D89A8F] text-[13px] font-medium mb-3">{item.hackathon}</p>
